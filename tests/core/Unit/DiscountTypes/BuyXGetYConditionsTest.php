...
/**
 * Dates, `max_uses`, the coupon and the channel are enforced by the query in
 * `DiscountManager::getDiscounts()`. The minimum spend, customer restrictions
 * and `max_uses_per_user` are only checked in `checkDiscountConditions()`, so
