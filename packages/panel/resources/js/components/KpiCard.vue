...
<template>
    <button
        type="button"
        :class="[
            'group text-left bg-surface border rounded-xl shadow-sm p-3.5 flex flex-col gap-2 transition-[background-color,border-color,box-shadow,transform] duration-100',
            'hover:bg-surface-2 hover:border-ink-300 active:translate-y-[0.5px] active:shadow-none focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-sage/35',
