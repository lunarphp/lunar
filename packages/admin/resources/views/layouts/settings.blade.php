                    ...
                    <x-hub::menu handle="settings"
                        ...
                        @foreach ($component->items as $item)
                            <a href="{{ route($item->route) }}"
                               ...
                               aria-current="page">
                                <span
                                      class="@if (!$item->isActive($component->attributes->get('current'))) text-gray-400 group-hover:text-gray-500 @else text-indigo-500 group-hover:text-indigo-500 @endif">
