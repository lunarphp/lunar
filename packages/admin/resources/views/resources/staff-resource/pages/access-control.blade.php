<x-filament-panels::page>
    <div class="fi-ta-ctn [&_table]:h-[1px] !overflow-auto">
        <table class="fi-ta-table">
            <thead>
                <tr>
                    ...
                    @foreach($this->roles as $role)
                        <th class="fi-ta-header-cell" style="text-align: center">
            ...
            <tbody>
                @foreach ($this->groupedPermissions as $groupedPermission)
                    <tr class="fi-ta-row">
                        <td
                            class="fi-ta-cell z-10 sticky left-0 bg-white dark:bg-gray-900 !p-3"
                    ...
                    @foreach($groupedPermission->children as $permission)
                        <tr class="fi-ta-row">
                            <td
                                class="fi-ta-cell py-2.5 !ps-6 pe-2 z-10 sticky left-0 bg-white dark:bg-gray-900"
                ...
                <tr class="fi-ta-row">
                    <td
                        class="fi-ta-cell z-10 sticky left-0 bg-gray-50 dark:bg-gray-800"
                    ></td>
                    @foreach($this->roles as $role)
                        <td
                            class="fi-ta-cell !p-0"
