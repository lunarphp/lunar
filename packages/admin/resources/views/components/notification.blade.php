  ...
  >
    ...
    >
      <div
        ...
        :class="{
          'border-red-600': level === 'error',
          'border-green-600': level !== 'error'
        }"
      >
        <div class="flex items-center gap-2">
          <div class="shrink-0">
            <span x-show="level === 'error'" class="text-red-600">
              <x-hub::icon ref="exclamation-circle" class="w-6 h-6" />
            </span>

            <span x-show="level !== 'error'" class="text-green-600">
              <x-hub::icon ref="check-circle" class="w-6 h-6" />
            </span>
          </div>
          ...
          <div class="flex shrink-0">
            ...
            >
              <x-hub::icon ref="x" class="w-4 h-4" />
            </button>
          </div>
        </div>
      </div>
