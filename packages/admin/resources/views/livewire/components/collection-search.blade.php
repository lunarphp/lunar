<div>
  ...
  <x-hub::slideover :title="__('adminhub::components.collection-search.title')" wire:model="showBrowser">
    <div
      class="space-y-4"
      x-data="{
        tab: 'search'
    ...
    >
      <div>
        <nav class="flex space-x-4" aria-label="Tabs">
          ...
          >
            {{ __('adminhub::components.collection-search.second_tab') }} ({{ $this->selectedModels->count() }})
          </button>
        </nav>
      </div>
