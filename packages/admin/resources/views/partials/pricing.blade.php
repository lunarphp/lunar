    ...
    <div class="overflow-hidden shadow sm:rounded-md">
        <div class="flex-col px-4 py-5 space-y-4 bg-white sm:p-6">
                ...
                <div class="flex items-center space-x-2">
                    <div>
                        <select wire:change="setCurrency($event.target.value)"
                                class="block w-full py-1 pl-2 pr-8 text-base text-gray-600 bg-gray-100 border-none rounded-md form-select focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm">
            ...
            <div class="flex items-center justify-between pt-4 border-t">
                ...
                <x-hub::button :disabled="!$currency->default" wire:click.prevent="addTier" theme="gray" size="sm"
                               type="button">
                            ...
                            <div class="grid w-full grid-cols-6 gap-4 pr-8">
                                ...
                                <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                    <x-hub::input.group
                                            :label="__(
                                                $this->pricesIncludeTax ?
                                                   'adminhub::global.unit_price_inc_tax' :
                                                   'adminhub::global.unit_price_excl_tax'
                                            )"
