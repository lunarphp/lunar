    ...
    <div class="flex-col px-4 py-5 space-y-4 bg-white sm:p-6">
      <header class="flex items-center justify-between">
        <div>
          ...
          <p class="text-sm text-gray-500">Product associations allow you to relate products to eachother.</p>
        </div>
      </header>
              ...
              <div class="border border-t-0 rounded-b">
                <div class="grid items-center grid-cols-12 p-4 text-sm">
                  ...
                  <div class="col-span-9">
                    <a class="block text-xs text-indigo-500 truncate hover:underline" href="#">Alfra Piccolo 38\/50B Magnetic Drilling Machine 240V (mag drill)</a>
                    <span class="text-gray-600">20054123</span>
                  </div>
          ...
          <div>
            <div class="rounded-b shadow-sm">
              ...
              <div class="text-sm border border-t-0 rounded-b">
                <p class="p-4 text-sm text-gray-600">Add Up-sell products by searching above and selecting products.</p>
              </div>
            </div>
          </div>
        </div>
