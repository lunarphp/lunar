<div class="hidden lg:flex lg:flex-shrink-0">
    <div class="relative flex flex-col bg-white border-r border-gray-100 dark:bg-gray-900 dark:border-gray-800"
         :class="{
             'w-64': showExpandedMenu && !settingsPanelOpen,
             'w-20': !showExpandedMenu || settingsPanelOpen,
         }"
        ...
        <a href="{{ route('hub.index') }}"
           class="flex items-center w-full h-16 px-4">
            <img src="https://getcandy.io/hub/getcandy_logo.svg"
                 alt="GetCandy Logo"
                 class="w-auto h-10"
                 x-show="showExpandedMenu && !settingsPanelOpen"
                 x-cloak />
        ...
        <button
                ...
                x-on:click="showExpandedMenu = !showExpandedMenu"
