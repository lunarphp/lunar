<div class="hidden lg:flex lg:flex-shrink-0">
    <div class="relative flex flex-col bg-white border-r border-gray-100 dark:bg-gray-900 dark:border-gray-800"
        ...
        <a href="{{ route('hub.index') }}"
           ...
           <x-hub::branding.logo x-show="!showExpandedMenu" :icon-only="true" />
        </a>
        ...
        <button x-on:click="showExpandedMenu = !showExpandedMenu"
                class="absolute z-50 p-1 bg-white border border-gray-100 dark:border-gray-700 dark:bg-gray-800 rounded -right-[13px] bottom-12 text-gray-600 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
