...
return [
    ...
    'form' => [
        ...
        'confirm' => [
            ...
            'hint' => [
                'capture' => 'Төлөлтийг төлөхийг баталгаажуулна уу',
    ...
    'infolist' => [
        ...
        'current_stock_level' => [
            'message' => 'Одоогийн агуулахын түвшин: :count',
        ],
        ...
        'alert' => [
            'requires_capture' => 'Энэ захиалгад төлөлт хийх шаардлагатай байна.',
    ...
    'action' => [
        ...
        'capture_payment' => [
            'label' => 'Төлөлт төлөх',
            'notification' => [
                'error' => 'Төлөхөд асуудал гарсан',
                'success' => 'Амжилттай төлсөн',
            ],
        ],
        'refund_payment' => [
            'label' => 'Буцаах',
