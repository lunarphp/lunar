...
return [
    ...
    'column_name' => 'Nom',
    'column_products' => 'Produits',
    'column_zones' => 'Zones',

    'section_details' => 'Détails',
    'field_name' => 'Nom',
    'name_placeholder' => 'ex. Marchandises dangereuses',

    'section_products' => 'Produits exclus',
    'products_desc' => 'Tout panier contenant l\'un de ces produits ne se voit proposer aucune expédition via les zones auxquelles cette liste est associée.',
    'add_products' => 'Ajouter des produits',
    'no_products' => 'Aucun produit pour le moment.',
    'kind_products' => 'Produits',

    'section_zones' => 'Zones associées',
    'zones_desc' => 'Associez ou retirez cette liste d\'une zone depuis la zone elle-même.',
    'no_zones' => 'Associée à aucune zone.',
    ...
    'flash_deleted' => 'Liste d\'exclusion supprimée.',
];
