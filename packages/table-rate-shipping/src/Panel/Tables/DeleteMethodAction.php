...
class DeleteMethodAction extends TableAction
{
    ...
    {
        return __('shipping::methods.confirm_delete');
    }

    public function url(mixed $record = null): ?string
    {
        return $record ? route('panel.settings.shipping.methods.destroy', $record) : null;
    }
}
