...
- The `last_four` column has been changed to a `VARCHAR` ([#282](https://github.com/lunarphp/lunar/issues/282)).
- When adding a purchasable to the cart, a potential difference in key order for meta is taken into account. [#271](https://github.com/lunarphp/lunar/pull/271)

### Changed

[View Changes](https://github.com/lunarphp/core/compare/2.0-beta12...2.0-beta13)
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta11...2.0-beta12)
...
- When a user logs in, the `CartSessionAuthListener` will now check for an active cart, rather than just grabbing the latest. ([#186](https://github.com/lunarphp/lunar/issues/186))
...
- When running the `lunar:meilisearch:setup` it will now wait for a period whilst the index is created before continuing. By [@lucasvmds](https://github.com/lucasvmds)
- `translate` method will now consider non array values passed and use the `$locale` parameter correctly [#251](https://github.com/lunarphp/lunar/issues/251). By [@armezit](https://github.com/armezit)
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta10...2.0-beta11)
...
- The `taxBreakdown` method on the tax driver now uses Data Transfer Objects. ([#173](https://github.com/lunarphp/lunar/issues/173))
...
- If an attribute value is null it will be returned instead of the `{"en": null}` encoded string. ([#130](https://github.com/lunarphp/lunar/issues/130))
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta8...2.0-beta9)
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta7...2.0-beta8)
...
- `TranslatedText` fieldtype now implements `JsonSerializable` interface ([#50](https://github.com/lunarphp/lunar/issues/50)).
...
- Added `customer_id` to orders so an order has a 1:1 relation to a customer. ([#73](https://github.com/lunarphp/lunar/issues/73)).
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta5...2.0-beta7)

## 2.0-beta5 - 2022-01-10

### Fixed

- Added check on customers for when using MySQL search driver to prevent undefined columns [#40](https://github.com/lunarphp/lunar/issues/40).
...
- Fixes [Issue 24](https://github.com/lunarphp/lunar/issues/24) where URL relationship is `elements` when it should be `element`.
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta3...2.0-beta4)
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta2...2.0-beta3)
...
[View Changes](https://github.com/lunarphp/core/compare/2.0-beta...2.0-beta2)
