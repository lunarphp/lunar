...
return [
    ...
    'permissions.settings:manage-api-keys.label' => 'مدیریت کلیدهای API',
    'permissions.settings:manage-api-keys.description' => 'به کارمند اجازه می‌دهد کلیدهای API مدیریتی صادر و باطل کند',
    'permissions.settings:read.label' => 'خواندن تنظیمات',
    'permissions.settings:read.description' => 'خواندن تنظیمات فروشگاه از طریق API',
    'permissions.catalog:read.label' => 'خواندن کاتالوگ',
    'permissions.catalog:read.description' => 'خواندن محصولات، مجموعه‌ها و برندها از طریق API',
    'permissions.sales:read.label' => 'خواندن فروش',
    'permissions.sales:read.description' => 'خواندن سفارش‌ها، مشتریان و تخفیف‌ها از طریق API',
