...
return [
    ...
    'permissions.settings:manage-api-keys.label' => 'Gestionar Claves API',
    'permissions.settings:manage-api-keys.description' => 'Permite al miembro del personal emitir y revocar claves API de administración',
    'permissions.settings:read.label' => 'Leer Configuraciones',
    'permissions.settings:read.description' => 'Leer la configuración de la tienda a través de la API',
    'permissions.catalog:read.label' => 'Leer Catálogo',
    'permissions.catalog:read.description' => 'Leer productos, colecciones y marcas a través de la API',
    'permissions.sales:read.label' => 'Leer Ventas',
    'permissions.sales:read.description' => 'Leer pedidos, clientes y descuentos a través de la API',
    ...
    'permissions.shipping:manage.label' => 'Gestionar Envíos',
    'permissions.shipping:manage.description' => 'Permite al miembro del personal gestionar los envíos',
];
