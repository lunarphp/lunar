...
return [
    ...
    'permissions.settings:manage-api-keys.label' => 'Manage API Keys',
    'permissions.settings:manage-api-keys.description' => 'Allow the staff member to issue and revoke admin API keys',
    'permissions.settings:read.label' => 'Read Settings',
    'permissions.settings:read.description' => 'Read store settings through the API',
    'permissions.catalog:read.label' => 'Read Catalogue',
    'permissions.catalog:read.description' => 'Read products, collections and brands through the API',
    'permissions.sales:read.label' => 'Read Sales',
    'permissions.sales:read.description' => 'Read orders, customers and discounts through the API',
