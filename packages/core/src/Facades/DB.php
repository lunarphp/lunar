...
/**
 * @method static ConnectionInterface build(array $config)
 ...
 * @method static Builder getSchemaBuilder()
 * @method static \Illuminate\Database\Query\Builder table(\Closure|\Illuminate\Database\Query\Builder|Expression|string $table, string|null $as = null)
 ...
 * @method static Grammar getQueryGrammar()
 * @method static Connection setQueryGrammar(Grammar $grammar)
