...
final class CheckoutTheme
{
    ...
    private const TOKENS = [
        ...
        'accentSoftBorder' => ['--accent-soft-border', 'color'],
        'accentRing' => ['--accent-ring', 'color'],
    ...
    public function __construct(
        ...
        // Tints the CSS derives from --accent by default (selected states,
        // soft panels, focus ring). Pin them when the derived mix is off-brand.
        public readonly ?string $accentSoft = null,
        public readonly ?string $accentSoftBorder = null,
        public readonly ?string $accentRing = null,
    ...
    public function with(
        ...
        ?string $accentSoftBorder = null,
        ?string $accentRing = null,
        ?string $bgPage = null,
