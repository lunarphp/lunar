...
class ContactInformation extends AbstractCheckoutElement
{
    ...
    /**
     * @return array{signedIn: bool, displayName: string|null, email: string|null, passkeysEnabled: bool, loginUrl: string|null, twoFactorUrl: string|null, logoutUrl: string|null}
     */
    public function props(): array
    {
        ...
        return [
            ...
            // When the login answers with a two-factor challenge the component
            // collects the code in place and posts it here (Fortify's
            // two-factor.login route), so the customer never leaves checkout.
            'twoFactorUrl' => Route::has('two-factor.login') ? route('two-factor.login') : null,
