...
final class LunarSetList
{
    ...
    public const V1_TO_V2_CLASS_RENAMES = [
        ...
        'Lunar\\Base\\Traits\\CachesProperties' => 'Lunar\\Core\\Concerns\\CachesProperties',
        'Lunar\\Base\\Traits\\CanScheduleAvailability' => 'Lunar\\Core\\Concerns\\CanScheduleAvailability',
        'Lunar\\Base\\Traits\\HasAttributes' => 'Lunar\\Core\\Concerns\\HasAttributes',
        'Lunar\\Base\\Traits\\HasChannels' => 'Lunar\\Core\\Concerns\\HasChannels',
        'Lunar\\Base\\Traits\\HasCustomerGroups' => 'Lunar\\Core\\Concerns\\HasCustomerGroups',
        'Lunar\\Base\\Traits\\HasDefaultRecord' => 'Lunar\\Core\\Concerns\\HasDefaultRecord',
        'Lunar\\Base\\Traits\\HasDimensions' => 'Lunar\\Core\\Concerns\\HasDimensions',
        'Lunar\\Base\\Traits\\HasMacros' => 'Lunar\\Core\\Concerns\\HasMacros',
        'Lunar\\Base\\Traits\\HasMedia' => 'Lunar\\Core\\Concerns\\HasMedia',
        'Lunar\\Base\\Traits\\HasModelExtending' => 'Lunar\\Core\\Concerns\\HasModelExtending',
        'Lunar\\Base\\Traits\\HasPersonalDetails' => 'Lunar\\Core\\Concerns\\HasPersonalDetails',
        'Lunar\\Base\\Traits\\HasPrices' => 'Lunar\\Core\\Concerns\\HasPrices',
        'Lunar\\Base\\Traits\\HasTags' => 'Lunar\\Core\\Concerns\\HasTags',
        'Lunar\\Base\\Traits\\HasTranslations' => 'Lunar\\Core\\Concerns\\HasTranslations',
        'Lunar\\Base\\Traits\\HasUrls' => 'Lunar\\Core\\Concerns\\HasUrls',
        'Lunar\\Base\\Traits\\LogsActivity' => 'Lunar\\Core\\Concerns\\LogsActivity',
        'Lunar\\Base\\Traits\\LunarUser' => 'Lunar\\Core\\Concerns\\IsLunarUser',
        'Lunar\\Base\\Traits\\Searchable' => 'Lunar\\Core\\Concerns\\Searchable',
