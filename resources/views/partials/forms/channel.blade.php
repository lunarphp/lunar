      ...
      <div class="p-6 text-sm">
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12 md:col-span-6">
            ...
            <p class="text-xs text-gray-600">Enter the name of the channel to delete it</p>
          </div>
          <div class="col-span-9 lg:col-span-4">
            <x-hub::input.text wire:model="deleteConfirm" />
          </div>
          <div class="col-span-3 text-right lg:col-span-2">
            <x-hub::button :disabled="!$this->canDelete" wire:click="delete" type="button">Delete</x-hub::button>
          </div>
        </div>
      </div>
    </div>
