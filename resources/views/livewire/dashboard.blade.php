<div>
  ...
  <div class="max-w-7xl mx-auto px-4 mt-8 sm:px-6 md:px-8">
    <div class="flex flex-row gap-x-8">
      <div class="basis-1/4">
        <div class="bg-white rounded-lg p-4 h-24 flex items-center">
          <div class="bg-blue-200 rounded-full w-12 h-12 ml-2 flex justify-center items-center">
      ...
      <div class="basis-1/4">
        <div class="bg-white rounded-lg p-4 pr-0 h-24 flex items-center">
          <div class="bg-indigo-50 rounded-full w-12 h-12 ml-2 flex justify-center items-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19 2H5C3.346 2 2 3.346 2 5V7.831C2 8.884 2.382 9.841 3 10.577V20C3 20.2652 3.10536 20.5196 3.29289 20.7071C3.48043 20.8946 3.73478 21 4 21H12C12.2652 21 12.5196 20.8946 12.7071 20.7071C12.8946 20.5196 13 20.2652 13 20V15H17V20C17 20.2652 17.1054 20.5196 17.2929 20.7071C17.4804 20.8946 17.7348 21 18 21H20C20.2652 21 20.5196 20.8946 20.7071 20.7071C20.8946 20.5196 21 20.2652 21 20V10.576C21.618 9.841 22 8.884 22 7.83V5C22 3.346 20.654 2 19 2ZM20 5V7.831C20 8.971 19.151 9.943 18.109 9.998L18 10C16.897 10 16 9.103 16 8V4H19C19.552 4 20 4.449 20 5ZM10 8V4H14V8C14 9.103 13.103 10 12 10C10.897 10 10 9.103 10 8ZM4 5C4 4.449 4.448 4 5 4H8V8C8 9.103 7.103 10 6 10L5.891 9.997C4.849 9.943 4 8.971 4 7.831V5ZM10 16H6V13H10V16Z" fill="#605BFF"/>
            </svg>
          </div>
          <div class="ml-4 flex items-center">
            <div>
              <strong class="text-lg font-bold">1,324</strong>
              <span class="text-xs block">No. of Orders</span>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="max-w-7xl mx-auto px-4 mt-8 sm:px-6 md:px-8">
    <div class="flex flex-row gap-x-8">
      <div class="basis-2/3">
        <div class="bg-white rounded-lg p-4 h-96">
          <h3 class="text-lg font-semibold text-gray-900 ml-4 mt-4">Sales Performance</h3>
          <div class="h-80">
            @livewire('hub.components.reporting.apex-chart', ['options' => $options1])
          </div>
        </div>
      </div>
      <div class="basis-1/3">
        <div class="bg-white rounded-lg p-4 h-96">
          <h3 class="text-lg font-semibold text-gray-900 ml-4 mt-4">Customer Group Orders</h3>
          <div class="h-80">
  ...
  <div class="max-w-7xl mx-auto px-4 mt-8 sm:px-6 md:px-8">
    <div class="flex flex-row gap-x-8">
      <div class="basis-2/3">
        <div class="bg-white rounded-lg p-8 h-96">
          <h3 class="text-lg font-semibold text-gray-900">Recent Orders</h3>
          <table class="w-full table-auto mt-8 font-sm">
            <thead>
              <tr class="border-b">
                <th class="text-left pb-2 font-normal text-sm">Order Ref</th>
                <th class="text-center pb-2 font-normal text-sm">Customer</th>
                <th class="text-center pb-2 font-normal text-sm">No. Items</th>
                <th class="text-center pb-2 font-normal text-sm">Placed At</th>
                <th class="text-right pb-2 font-normal text-sm">Total</th>
              </tr>
            </thead>
            <tbody>
              <tr>
      ...
      <div class="basis-1/3">
        <div class="bg-white rounded-lg p-8 h-96">
          ...
          <div class="relative bg-white py-8 border-b border-slate-100 flex items-center space-x-3">
            <div class="flex-shrink-0">
              <img class="h-24 w-24 rounded-lg" src="https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
            </div>
          ...
          <div class="relative bg-white py-8 border-slate-100 flex items-center space-x-3">
            <div class="flex-shrink-0">
              <img class="h-24 w-24 rounded-lg" src="https://images.unsplash.com/photo-1511556532299-8f662fc26c06?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
            </div>
            <div class="flex-1 min-w-0">
              <a href="#" class="focus:outline-none">
                <span class="absolute inset-0" aria-hidden="true"></span>
