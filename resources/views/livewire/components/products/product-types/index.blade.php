<div class="flex-col px-12 space-y-4">
  <div class="flex items-center justify-between">
    ...
    <div class="text-right">
      <x-hub::button tag="a" href="{{ route('hub.product-type.create') }}">
  ...
  <div>
    <x-hub::table>
      <x-slot name="toolbar">
        <div class="p-4">
          <x-hub::input.text wire:model="search" placeholder="Search by attribute or SKU" class="py-2" />
        </div>
      </x-slot>
      <x-slot name="head">
        <x-hub::table.heading>
      ...
      <x-slot name="body">
        @forelse($productTypes as $type)
          ...
          <x-hub::table.cell>
            <a href="{{ route('hub.product-type.show', $type->id) }}" class="text-indigo-500 hover:underline">
              Edit
            </a>
          </x-hub::table.cell>
          </x-hub::table.row>
